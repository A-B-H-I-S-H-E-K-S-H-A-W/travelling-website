...
const CardItems = ({ paginationRender = true }) => {
  return (
    <div className="md:px-20 sm:px-5 px-3 pb-10">
      ...
      {paginationRender ? (
        <div className="bg-white pt-5 text-center dark:bg-dark ">
          <div className="mb-12 inline-flex justify-center rounded bg-white p-3">
            <ul className="inline-flex overflow-hidden rounded-lg border border-stroke dark:border-white/5 shadow-md">
              <li>
                <button className="flex md:h-14 md:min-w-14 h-8 min-w-8 items-center justify-center border-r border-stroke px-2 text-base font-medium text-dark hover:bg-gray-2 dark:border-white/10 dark:text-white dark:hover:bg-white/5">
                  <svg
                    width="20"
                    height="21"
                    viewBox="0 0 20 21"
              ...
              <li>
                <button className="flex md:h-14 md:min-w-14 h-8 min-w-8 items-center justify-center px-2 text-base font-medium text-dark hover:bg-gray-2 dark:border-white/10 dark:text-white dark:hover:bg-white/5">
                  <svg
                    width="20"
                    height="21"
                    viewBox="0 0 20 21"
